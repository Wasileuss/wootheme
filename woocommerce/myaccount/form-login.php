...
<div class="container-fluid">
    <div class="row px-xl-5">
        ...
        <?php $column_class = ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) ? 'col-md-6' : 'col-md-12'; ?>
        ...
        <div class="<?php echo $column_class ?>" id="customer_login">
            ...
            <div class="woocommerce-order bg-light p-30 mb-2 h-100">
                ...
                <form class="woocommerce-form woocommerce-form-login login" method="post">
                    ...
                    <div class="form-group form-check">
                        ...
                        <label for="rememberme"
                               class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme form-check-label"><?php esc_html_e( 'Remember me', 'woocommerce' ); ?></label>
                    ...
                    <div>
                        <button type="submit"
                                class="woocommerce-button button woocommerce-form-login__submit button alt btn btn-primary py-2 px-4 mb-3"
                                name="login"
                ...
                <div class="woocommerce-order bg-light p-30 mb-2 h-100">
                    ...
                    <form method="post"
                        ...
                        <div>
                            ...
                            <button type="submit"
                                    class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit btn btn-primary py-2 px-4 mb-3"
                                    name="register"
